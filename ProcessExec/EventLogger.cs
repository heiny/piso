...
namespace ProcessExec
{
    public class EventLogger
    {
        ...
        public static EventLogger HostDriver { get; private set; }
        public static EventLogger HostController { get; private set; }

        static EventLogger()
        {
            ProcessHost = Create("ProcessHost");
            HostDriver = Create("HostDriver");
            HostController = Create("HostController");
        }
