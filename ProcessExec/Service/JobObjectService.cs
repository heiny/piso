...
namespace ProcessExec.Service
{
    ...
    public class JobObjectService : IJobObjectService, IDisposable
    {
        ...
        // TODO: job objects dont support disk quotas so we will need to set elsewhere
        // TODO: we might need to hook the completion port for messages pertaining to over limits if the process doesn't crash
